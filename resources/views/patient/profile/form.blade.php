<div class="form-group">
    ...
    <input class="form-control {{ $errors->has('first_name') ? 'is-invalid' : ''}}" name="first_name" type="text"
        id="first_name" value="{{ isset($patient->first_name) ? $patient->first_name : old('first_name')}}">
...
<div class="form-group">
    ...
    <input class="form-control {{ $errors->has('date_of_birth') ? 'is-invalid' : ''}}" name="date_of_birth" type="date"
        id="date_of_birth" value="{{ isset($patient->date_of_birth) ? $patient->date_of_birth : old('date_of_birth')}}">
    {!! $errors->first('date_of_birth', '<p class="text-danger">:message</p>') !!}
</div>
<div class="form-group">
    <label for="weight" class="control-label">{{ 'Weight' }}</label>
    <input class="form-control  {{ $errors->has('weight') ? 'is-invalid' : ''}}" name="weight" type="number" id="weight"
        value="{{ isset($patient->weight) ? $patient->weight : old('weight')}}">
    {!! $errors->first('weight', '<p class="text-danger">:message</p>') !!}
</div>
<div class="form-group">
    <label for="height" class="control-label">{{ 'Height' }}</label>
    <input class="form-control {{ $errors->has('height') ? 'is-invalid' : ''}}" name="height" type="number" id="height"
...
<div class="form-group">
    ...
    <input class="form-control {{ $errors->has('policy_number') ? 'is-invalid' : ''}}" name="policy_number" type="text"
        id="policy_number" value="{{ isset($patient->policy_number) ? $patient->policy_number : old('policy_number')}}">
    {!! $errors->first('policy_number', '<p class="text-danger">:message</p>') !!}
</div>
<div class="form-group">
    <label for="expiary_date" class="control-label">{{ 'Expiary Date' }}</label>
    <input class="form-control {{ $errors->has('expiary_date') ? 'is-invalid' : ''}}" name="expiary_date" type="date"
        id="expiary_date" value="{{ isset($patient->expiary_date) ? $patient->expiary_date : old('expiary_date')}}">
