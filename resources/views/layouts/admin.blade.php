...
<body class="fixed-nav sticky-footer" id="page-top">
	...
	<script src="{{ asset('admin/jquery.selectbox-0.2.js') }}"></script>
	<script src="{{ asset('admin/retina-replace.min.js') }}"></script>
	<script src="{{ asset('admin/jquery.magnific-popup.min.js') }}"></script>
