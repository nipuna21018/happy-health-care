			...
			<div class="col-lg-4 col-md-6">
				<div class="box_list home">
					...
					<figure>
						...
						<a href="detail-page.html"><img src="http://via.placeholder.com/565x565.jpg" class="img-fluid"
								alt=""></a>
					...
					<div class="wrapper">
						...
						<a href="#0" data-toggle="tooltip" data-placement="top" data-original-title="Badge Level"
							class="badge_list_1"><img src="landing/img/badges/badge_1.svg" width="15" height="15"
								alt=""></a>
					</div>
					<ul>
				...
				<div class="box_list home">
					...
					<div class="wrapper">
						...
						<span class="rating"><i class="icon_star voted"></i><i class="icon_star voted"></i><i
							...
							<small>(145)</small></span>
						<a href="#0" data-toggle="tooltip" data-placement="top" data-original-title="Badge Level"
							class="badge_list_1"><img src="landing/img/badges/badge_2.svg" width="15" height="15"
								alt=""></a>
					</div>
					<ul>
						<li><i class="icon-eye-7"></i> 854 Views</li>
				...
				<div class="box_list home">
					...
					<div class="wrapper">
						...
						<span class="rating"><i class="icon_star voted"></i><i class="icon_star voted"></i><i
							...
							<small>(145)</small></span>
						<a href="#0" data-toggle="tooltip" data-placement="top" data-original-title="Badge Level"
							class="badge_list_1"><img src="landing/img/badges/badge_6.svg" width="15" height="15"
								alt=""></a>
					</div>
					<ul>
						<li><i class="icon-eye-7"></i> 854 Views</li>
...
<div id="app_section">
	<div class="container">
		<div class="row justify-content-around">
			<div class="col-md-5">
				<p><img src="landing/img/app_img.svg" alt="" class="img-fluid" width="500" height="433"></p>
			</div>
			<div class="col-md-6">
				<small>Application</small>
				<h3>Download <strong>Findoctor App</strong> Now!</h3>
				<p class="lead">Tota omittantur necessitatibus mei ei. Quo paulo perfecto eu, errem percipit ponderum no
					eos. Has eu mazim sensibus. Ad nonumes dissentiunt qui, ei menandri electram eos. Nam iisque
					consequuntur cu.</p>
				<div class="app_buttons wow" data-wow-offset="100">
					...
					<a href="#0" class="fadeIn"><img src="landing/img/apple_app.png" alt="" width="150" height="50"
							data-retina="true"></a>
					<a href="#0" class="fadeIn"><img src="landing/img/google_play_app.png" alt="" width="150"
