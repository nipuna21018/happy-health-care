<div class="form-group {{ $errors->has('first_name') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="first_name" type="text" id="first_name" value="{{ isset($pharmacy->first_name) ? $pharmacy->first_name : ''}}"  >
    {!! $errors->first('first_name', '<p class="help-block">:message</p>') !!}
</div>
<div class="form-group {{ $errors->has('last_name') ? 'has-error' : ''}}">
    <label for="last_name" class="control-label">{{ 'Last Name' }}</label>
    <input class="form-control" name="last_name" type="text" id="last_name" value="{{ isset($pharmacy->last_name) ? $pharmacy->last_name : ''}}"  >
    {!! $errors->first('last_name', '<p class="help-block">:message</p>') !!}
</div>
<div class="form-group {{ $errors->has('registration_number') ? 'has-error' : ''}}">
    <label for="registration_number" class="control-label">{{ 'Registration Number' }}</label>
    <input class="form-control" name="registration_number" type="text" id="registration_number" value="{{ isset($pharmacy->registration_number) ? $pharmacy->registration_number : ''}}"  >
    {!! $errors->first('registration_number', '<p class="help-block">:message</p>') !!}
</div>
<div class="form-group {{ $errors->has('email') ? 'has-error' : ''}}">
    <label for="email" class="control-label">{{ 'Email' }}</label>
    <input class="form-control" name="email" type="text" id="email" value="{{ isset($pharmacy->email) ? $pharmacy->email : ''}}"  >
    {!! $errors->first('email', '<p class="help-block">:message</p>') !!}
</div>
<div class="form-group {{ $errors->has('contact_number') ? 'has-error' : ''}}">
    <label for="contact_number" class="control-label">{{ 'Contact Number' }}</label>
    <input class="form-control" name="contact_number" type="text" id="contact_number" value="{{ isset($pharmacy->contact_number) ? $pharmacy->contact_number : ''}}"  >
...
<div class="form-group {{ $errors->has('pharmacy_name') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="pharmacy_name" type="text" id="pharmacy_name" value="{{ isset($pharmacy->pharmacy_name) ? $pharmacy->pharmacy_name : ''}}"  >
...
<div class="form-group {{ $errors->has('pharmacy_phone') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="pharmacy_phone" type="text" id="pharmacy_phone" value="{{ isset($pharmacy->pharmacy_phone) ? $pharmacy->pharmacy_phone : ''}}"  >
...
<div class="form-group {{ $errors->has('fax_number') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="fax_number" type="text" id="fax_number" value="{{ isset($pharmacy->fax_number) ? $pharmacy->fax_number : ''}}"  >
