<div class="box_general padding_bottom">
    ...
    <label for="pharmacy_city" class="control-label">{{ 'City' }}</label>
    <input class="form-control" name="pharmacy_city" type="text" id="pharmacy_city"
        value="{{ isset($pharmacy->pharmacy_city) ? $pharmacy->pharmacy_city :  old('pharmacy_city') }}">
    {!! $errors->first('pharmacy_city', '<p class="help-block text-danger">:message</p>') !!}
</div> --}}
<div class="row">
    <div class="col-md-6">
