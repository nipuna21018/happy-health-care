 <div class="box_general padding_bottom">
    ...
    <label for="first_name" class="control-label {{ $errors->has('first_name') ? 'text-danger' : ''}}">{{ 'First Name' }}</label>
    <input class="form-control" name="first_name" type="text" id="first_name" value="{{ isset($doctor->first_name) ? $doctor->first_name : old('first_name') }}" required>
    {!! $errors->first('first_name', '<p class="help-block text-danger">:message</p>') !!}
</div>
<div class="form-group {{ $errors->has('last_name') ? 'has-error' : ''}}">
    <label for="last_name" class="control-label {{ $errors->has('last_name') ? 'text-danger' : ''}}">{{ 'Last Name' }}</label>
...
<div class="form-group {{ $errors->has('institute_address') ? 'has-error' : ''}}">
    <label for="institute_address" class="control-label {{ $errors->has('institute_address') ? 'text-danger' : ''}}">{{ 'Institute Address' }}</label>
    <textarea class="form-control" rows="5" name="institute_address" type="textarea" id="institute_address" >{{ isset($doctor->institute_address) ? $doctor->institute_address : old('institute_address')}}</textarea>
...
<div class="form-group {{ $errors->has('email') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="email" type="text" id="email" value="{{ isset($doctor->email) ? $doctor->email : old('email') }}" required>
    {!! $errors->first('email', '<p class="help-block text-danger">:message</p>') !!}
</div>
<div class="form-group {{ $errors->has('mobile') ? 'has-error' : ''}}">
    <label for="mobile" class="control-label {{ $errors->has('mobile') ? 'text-danger' : ''}}">{{ 'Mobile' }}</label>
    <input class="form-control" name="mobile" type="text" id="mobile" value="{{ isset($doctor->mobile) ? $doctor->mobile : old('mobile') }}" required>
    {!! $errors->first('mobile', '<p class="help-block text-danger">:message</p>') !!}
</div>
<div class="form-group {{ $errors->has('date_of_birth') ? 'has-error' : ''}}">
    <label for="date_of_birth" class="control-label {{ $errors->has('date_of_birth') ? 'text-danger' : ''}}">{{ 'Date Of Birth' }}</label>
    <input class="form-control" name="date_of_birth" type="date" id="date_of_birth" value="{{ isset($doctor->date_of_birth) ? $doctor->date_of_birth : old('date_of_birth') }}" >
    {!! $errors->first('date_of_birth', '<p class="help-block text-danger">:message</p>') !!}
</div>
<div class="form-group {{ $errors->has('gender') ? 'has-error' : ''}}">
    <label for="gender" class="control-label {{ $errors->has('gender') ? 'text-danger' : ''}}">{{ 'Gender' }}</label>
    <select name="gender" class="form-control" id="gender" >
    @foreach (json_decode('{"male":"Male","female":"Female"}', true) as $optionKey => $optionValue)
        <option value="{{ $optionKey }}" {{ (isset($doctor->gender) && $doctor->gender == $optionKey) || (old('gender') == $optionKey) ? 'selected' : ''}}>{{ $optionValue }}</option>
    @endforeach
</select>
    {!! $errors->first('gender', '<p class="help-block text-danger">:message</p>') !!}
</div>
<div class="form-group {{ $errors->has('marital_status') ? 'has-error' : ''}}">
    <label for="marital_status" class="control-label {{ $errors->has('marital_status') ? 'text-danger' : ''}}">{{ 'Marital Status' }}</label>
    <select name="marital_status" class="form-control" id="marital_status" >
    @foreach (json_decode('{"married":"Married","single":"Single"}', true) as $optionKey => $optionValue)
        <option value="{{ $optionKey }}" {{ (isset($doctor->marital_status) && $doctor->marital_status == $optionKey) || (old('marital_status') == $optionKey) ? 'selected' : ''}}>{{ $optionValue }}</option>
    @endforeach
</select>
    {!! $errors->first('marital_status', '<p class="help-block text-danger">:message</p>') !!}
</div>
<div class="form-group {{ $errors->has('nationality') ? 'has-error' : ''}}">
    <label for="nationality" class="control-label {{ $errors->has('nationality') ? 'text-danger' : ''}}">{{ 'Nationality' }}</label>
...
<div class="form-group {{ $errors->has('registration_number') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="registration_number" type="text" id="registration_number" value="{{ isset($doctor->registration_number) ? $doctor->registration_number : old('registration_number') }}" >
    {!! $errors->first('registration_number', '<p class="help-block text-danger">:message</p>') !!}
</div>
<div class="form-group {{ $errors->has('user_id') ? 'has-error' : ''}}">
    <label for="user_id" class="control-label {{ $errors->has('user_id') ? 'text-danger' : ''}}">{{ 'User Id' }}</label>
    <input class="form-control" name="user_id" type="number" id="user_id" value="{{ isset($doctor->user_id) ? $doctor->user_id : old('user_id') }}" >
